...
const mockPerformanceData = [
  { name: "Share Value Growth", value: 15000, color: "#025AA2" },
  { name: "Dividends", value: 5475, color: "#00A2AE" },
  { name: "Bonus Shares", value: 2040, color: "#FFCE03" },
]
...
export default function PerformanceBreakdownChart({ className }: PerformanceBreakdownChartProps) {
  ...
  return (
    <Card className={className}>
      ...
      <CardContent>
        <div className="mb-4 p-4 rounded-lg bg-gradient-to-r from-amhara-blue/5 to-amhara-yellow/5">
